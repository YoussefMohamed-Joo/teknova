...
export default function Hero3D() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const particlesMat = new THREE.PointsMaterial({ size: 0.02, color: 0x00d4ff, transparent: true, opacity: 0.4 });
  ...
  if (error) {
    return <div className="flex-1 flex items-center justify-center min-h-[40vh] lg:min-h-screen">
      <div className="text-zinc-600 text-xs font-mono">3D Unavailable</div>
    </div>;
  }
  ...
  return (
    <div className="flex-1 flex items-center justify-center min-h-[40vh] lg:min-h-screen relative">
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle at 50% 50%, rgba(0,212,255,0.06) 0%, transparent 60%)" }}
