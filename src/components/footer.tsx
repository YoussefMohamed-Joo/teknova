  ...
  return (
    <footer className="py-12 md:py-16">
      <div className="mx-4 md:mx-8 lg:mx-16">
        <div className="section-glass p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 border border-zinc-800 rounded-full px-4 py-1.5 text-[10px] text-zinc-400 hover:border-zinc-600 transition-all"
              >
                📞 واتساب
              </a>
            </div>
          ...
          <div className="flex justify-center gap-3 mb-6">
            {socials.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs hover:border-zinc-600 transition-all"
              >
                {s.icon}
              </a>
            ))}
          ...
          <div className="border-t border-zinc-900 pt-6 text-center">
            <p className="text-zinc-700 text-[10px]">
              &copy; {new Date().getFullYear()} TEKNOVA
            </p>
          </div>
        </div>
      </div>
